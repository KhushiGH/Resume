...
* High Availability using Pacemaker and Corosync
* Workload Scheduling using SLURM
* Distributed Storage using BeeGFS
* Centralized Authentication using LDAP
* Monitoring and Logging using ELK Stack and Zabbix
* Automated compute node recovery using AWS Boto3

This project demonstrates real-world infrastructure design, automation, and system reliability.
...
Cluster and HPC Tools
SLURM, BeeGFS, Pacemaker, Corosync
...
* Ability to design high availability systems
...
GitHub
https://github.com/khushi-pghpcsa
